...
const Blob4 = () => {
  return (
    <>
        <svg id="gl5" className="glow" width="358" height="358" viewBox="0 0 358 358" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
            <linearGradient id="col5" gradientTransform="rotate(125)">
